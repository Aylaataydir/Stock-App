        ...
        <div className="mx-auto flex w-full max-w-6xl flex-col gap-8 px-6 py-8 md:px-10">
          <header className="flex items-center justify-between rounded-xl border bg-card px-4 py-3 md:px-6">
            ...
            <div className="flex items-center gap-2">
              <Button
                className={`cursor-pointer ${theme === "dark" || theme === "system"  ? "block" : "hidden"}`}
                type="button"
              ...
              <Button
                className={` cursor-pointer ${theme === "light" || theme === "system"  ? "block" : "hidden"}`}
                type="button"
          ...
          <section className="grid gap-6 rounded-xl border bg-card p-6 md:grid-cols-2 md:p-10">
            <div className="space-y-4">
              ...
              <p className="text-muted-foreground md:text-lg">
                Smart Stock System helps teams control inventory, monitor
                purchases and sales, and keep operations organized from one
                place.
              </p>
            ...
            <Card className="border-dashed">
              <CardHeader>
                ...
                <CardDescription>
                  Keep your inventory workflow simple, auditable, and easier to
                  scale.
                </CardDescription>
              </CardHeader>
              <CardContent>
                <ul className="space-y-3 text-sm text-muted-foreground">
                  <li>
                    • Reduce manual stock mistakes with centralized records.
                  </li>
                  <li>
                    • Monitor business movement across products and suppliers.
                  </li>
                  <li>
                    • Prepare reports quickly for better purchasing decisions.
                  </li>
                </ul>
              </CardContent>
            </Card>
